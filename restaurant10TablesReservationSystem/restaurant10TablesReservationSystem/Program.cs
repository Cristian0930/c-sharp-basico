...
/*
 * 1. Validar si es usuario existente o si debe registrarse, y generar un sistema de registro o login
...
while (arrayCurrentIndex < 10)
{
    ...
    if (userType)
    {
        ...
        int index = Array.IndexOf(userNames, userToSearch); // Buscar en un array
